...
function clearList() {
    let userInput = document.querySelectorAll('#list')
    userInput.forEach(userI => userI.remove())
}
// clear the function. userI => userI.remove() <-- this is a function inside of a function. 